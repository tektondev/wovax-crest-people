<div class="tre-property-single">
    	...
    	<div class="wrap">
            ...
            <?php echo $slideshow_html;?>
                    ...
                    <ul class="property-data">
                        ...
                        <li><span>PRICE/ SQ FEET:</span> [$600]</li>
    ...
    <section class="tre-property-details">
    	<h2 class="tre-accordion">Property Details</h2>
        	...
        	<ul class="property-list-details">
                ...
                <li>
                	<ul class="property-data">
                        ...
                        <?php if ( $type ):?><li><span>Living Area:</span> [4,000]</li><?php endif;?>
                        <?php if ( $type ):?><li><span>Year Built:</span> [2016]</li><?php endif;?>
                        <?php if ( $type ):?><li><span>Property Class:</span> [Single Family]</li><?php endif;?>
                    </ul>
                </li>
        	</ul>
        </div>
        <h2 class="tre-accordion">Amenities</h2>
        <div class="tre-accordion-content">
        	<ul class="property-pins">
        ...
        <h2 class="tre-accordion">Features</h2>
        <div class="tre-accordion-content">
        ...
        <h2 class="tre-accordion">Fees</h2>
